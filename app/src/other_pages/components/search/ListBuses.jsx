...
function ListBuses() {
  ...
  return (
    <div className="bg-gray-900 p-2 px-4">
      ...
      <div className="gap-1 flex-col px-2 flex overflow-hidden rounded-md">
        {buses
          .filter((bus) => bus.capacity >= 50) // Only buses with capacity 50 or above
          .map((bus) => {
              ...
              >
                <div className="flex justify-between">
                  <div className="flex flex-col">
                    ...
                    <span>
                      <span className="font-semibold mt-3 opacity-80">
                        {bus.capacity} Seater
                      </span>
                    </span>
                  </div>
