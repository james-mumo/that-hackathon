export const appName = "CareTransit";
...
export const buses = [
  {
    ...
    wheelchairAccessible: true, // Accessibility feature
    rampAvailability: true, // Accessibility feature
    reservedSeats: 5, // Accessibility feature
  ...
  },
  {
    ...
    wheelchairAccessible: true, // Accessibility feature
    rampAvailability: true, // Accessibility feature
    reservedSeats: 4, // Accessibility feature
    stepFreeAccess: false, // Accessibility feature
    calculateFare: function () {
      let totalFare = 0;
      const route = routes.find((route) => route.id === this.routeId);
      const currentStageIndex = route.stages.findIndex(
