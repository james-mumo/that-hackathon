...
import Location from "../../other_pages/components/settings/Location";
import { IoInformationCircleOutline } from "react-icons/io5";
import { LuLaugh } from "react-icons/lu";
import { FaGithub } from "react-icons/fa6";
import { FaRegShareFromSquare } from "react-icons/fa6";
import BusLocation from "../../other_pages/components/settings/BusLocation";
import AddRoadNotifications from "../../other_pages/components/settings/AddRoadNotifications";
import UserDetails from "../../other_pages/UserDetails";
  ...
  return (
    <div className="flex flex-col bg-gray-800 w-full gap-2 h-screen overflow-scroll pb-28">
      <div className="grid grid-cols-3 gap-3">
        <div
          className="flex items-center py-2 px-4 text-white cursor-pointer hover:bg-slate-900 h-36"
        ...
        <div className="flex items-center py-2 px-4 text-white cursor-pointer hover:bg-slate-900 h-36">
          <div className="bg-teal-500 rounded-full p-2">
        ...
        <div className="flex items-center py-2 px-4 text-white cursor-pointer hover:bg-slate-900 h-36">
          ...
          <div className="flex flex-col ml-4">
            ...
            <span className="text-sm opacity-80">
              github.com/evans-mutugi/care_transit
            </span>
          </div>
        </div>
        <div className="flex items-center py-2 px-4 text-white cursor-pointer hover:bg-slate-900 h-36">
