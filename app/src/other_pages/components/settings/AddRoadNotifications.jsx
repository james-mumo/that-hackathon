...
function AddRoadNotifications() {
  ...
  return (
    <div className="flex flex-col h-fit pb-10 bg-gradient-to-br from-teal-900 overflow-x-hidden to-emerald-900 border-teal-400 rounded-md border px-2 overflow-scroll w-3/4">
      <span className="font-semibold mt-2">Add Notification</span>
      <select
      ...
      <select
        ...
        className="p-2 mt-4 rounded-md border border-gray-300 focus:outline-none focus:border-teal-500"
      >
        <option value="">Select Stages Affected</option>
      ...
      <div className="mt-4">
        <p className="font-semibold text-yellow-400">Selected Stages:</p>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gray-950 px-4 py-5 rounded-md border border-dashed border-emerald-800">
            <span className="text-xl font-semibold flex-1 justify-center flex border-b mb-2 text-yellow-400">
            ...
            <span className="text-md border-b border-double border-opacity-75 border-gray-600 font-semibold flex flex-1 text-center justify-center text-yellow-400">
              {notification}
            </span>
            <div>
              ...
              <span className="font-semibold text-[12px] text-teal-400">
