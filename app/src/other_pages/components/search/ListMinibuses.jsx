  ...
  return (
    <div className="bg-gray-900 p-2 px-4">
      <div className="flex flex-col">
        <span className="text-yellow-400 font-semibold pl-2">Minibuses</span>
      </div>
      <div className="gap-1 flex-col px-2 flex rounded-md">
        {buses
          .filter((bus) => (bus.capacity = 30)) // Only buses with capacity 50 or above
          .map((bus) => {
