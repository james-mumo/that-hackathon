...
//     capacity: 50,
//     sacco: "Metro Trans",
//     numberPlate: "KAB 456Y",
//     wheelchairAccessible: false, // Accessibility feature
//     rampAvailability: false, // Accessibility feature
//     reservedSeats: 3, // Accessibility feature
//     stepFreeAccess: true, // Accessibility feature
//     calculateFare: function () {
//       let totalFare = 0;
//       const route = routes.find((route) => route.id === this.routeId);
//       const currentStageIndex = route.stages.findIndex(
...
export const buses = [
  ...
  },
  {
    ...
    routeId: 13,
    to: "CBD",
    currentLocation: "Outer Ring Road",
    distanceToCurrentLocation: 5.0,
    timeToCurrentLocation: 25,
    distanceToStage: 1.5,
    timeToStage: 8,
    capacity: 30,
    sacco: "Metro Trans",
    numberPlate: "KAE 456X",
    wheelchairAccessible: false,
    rampAvailability: false,
    reservedSeats: 2,
    stepFreeAccess: true,
  ...
  },
  {
    ...
    routeId: 13,
    to: "Komarock",
    currentLocation: "Haile Selassie Avenue",
    distanceToCurrentLocation: 3.0,
    timeToCurrentLocation: 15,
    distanceToStage: 3.5,
    timeToStage: 17,
    capacity: 30,
    sacco: "Metro Trans",
    numberPlate: "KAF 789Y",
    wheelchairAccessible: true,
    rampAvailability: true,
    reservedSeats: 4,
    stepFreeAccess: true,
  ...
  },
  {
    ...
    routeId: 13,
    to: "CBD",
    currentLocation: "Komarock",
    distanceToCurrentLocation: 5.0,
    timeToCurrentLocation: 20,
    distanceToStage: 1.5,
    timeToStage: 8,
    capacity: 50,
    sacco: "Metro Trans",
    numberPlate: "KAJ 345V",
    wheelchairAccessible: false,
    rampAvailability: false,
    reservedSeats: 3,
    stepFreeAccess: true,
  ...
  },
  {
    ...
    to: "Komarock",
    currentLocation: "Outer Ring Road",
    distanceToCurrentLocation: 4.5,
    timeToCurrentLocation: 20,
    distanceToStage: 3.5,
    timeToStage: 17,
    capacity: 12,
    sacco: "FikaSafe",
    numberPlate: "KAN 123R",
    wheelchairAccessible: true,
    rampAvailability: true,
    reservedSeats: 5,
    stepFreeAccess: true,
  ...
  },
  {
    ...
    currentLocation: "Komarock",
    distanceToCurrentLocation: 5.0,
    timeToCurrentLocation: 22,
    distanceToStage: 1.5,
    timeToStage: 8,
    capacity: 50,
    sacco: "FikaSafe",
    numberPlate: "KAP 456Q",
    wheelchairAccessible: false,
    rampAvailability: false,
    reservedSeats: 4,
    stepFreeAccess: true,
